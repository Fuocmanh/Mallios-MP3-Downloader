...
DRIVE_AUTH_BACKUP_FILE = CONFIGS_DIR / "drive_auth.backup.json"
...
def load_auth() -> dict:
    """Tải auth; khôi phục bản sao nếu file chính bị reset hoặc hỏng."""
    for auth_file in (DRIVE_AUTH_FILE, DRIVE_AUTH_BACKUP_FILE):
